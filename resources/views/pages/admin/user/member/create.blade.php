...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page"><a href="/dashboard/user">Member</a></li>
      ...
      <div class="card">
        ...
        <div class="card-body">
            <form class="form-floating" action="/dashboard/user-member" method="post">
                @csrf
                ...
                <div class="form-floating mb-3">
                    <textarea name="alamat" id="alamat" cols="2" rows="4" class="form-control @error("alamat") is-invalid @enderror" placeholder="Alamat" required>{{ old('alamat') }}</textarea>
                ...
                <div class="form-floating mb-3">
                    <input type="number" name="telp" class="form-control @error("telp") is-invalid @enderror" id="telp" placeholder="Nomor Telephone"  required value="{{ old('telp') }}">
